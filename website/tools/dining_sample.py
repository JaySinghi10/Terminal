...
Read from android/lib/dining.ts, the app's own dataset, so the site
...
DATA = os.path.join(SITE, '..', 'android', 'lib', 'dining.ts')
...
def main():
    ...
    head = ('/* Generated by tools/dining_sample.py from android/lib/dining.ts.\n'
