...
// when it differs from "name city" — a row carrying an alias, a discarded
// municipality tail, or a diacritic. Where a row has diacritics the generator
// appended the folded ASCII copy; normalizeTerm folds at build time as well
// now, so those copies are redundant and harmless, and a query folds the same
// way. THE WORLD ALIASES — historical names, endonyms, nicknames and native
// scripts for the major cities of every region — are appended to `search` by
// tools/add_aliases.mjs from the table in tools/aliases.mjs. Edit the table
// and run the tool; the rows below are rewritten in place, and the test file
// proves every alias lands on its own row and nowhere else. See the note at
// normalizeTerm for which scripts the device can read.
//
...
const AIRPORT_ROWS: Row[] = [
  ...
  ["ACC", "Kotoka International Airport", "Accra", "Ghana", "Africa/Accra", 5.6052, -0.1668, "kotoka international airport accra аккра"],
  ...
  ["ADB", "Adnan Menderes International Airport", "Gaziemir", "Turkey", "Europe/Istanbul", 38.2924, 27.1570, "adnan menderes international airport gaziemir izmir smyrna измир"],
  ["ADD", "Addis Ababa Bole International Airport", "Addis Ababa", "Ethiopia", "Africa/Addis_Ababa", 8.9779, 38.7993, "addis ababa bole international airport addis ababa addis abeba አዲስ አበባ аддис-абеба"],
  ["ADE", "Aden International Airport", "Aden", "Yemen", "Asia/Aden", 12.8296, 45.0300, "aden international airport aden عدن"],
  ...
  ["AER", "Sochi International Airport", "Sochi", "Russia", "Europe/Moscow", 43.4499, 39.9566, "sochi international airport sochi сочи adler"],
  ...
  ["AKL", "Auckland International Airport", "Auckland", "New Zealand", "Pacific/Auckland", -37.0120, 174.7863, "auckland international airport auckland tamaki makaurau окленд オークランド 奥克兰"],
  ["AKX", "Aktobe International Airport", "Aktobe", "Kazakhstan", "Asia/Aqtobe", 50.2481, 57.2041],
  ["ALA", "Almaty International Airport", "Almaty", "Kazakhstan", "Asia/Almaty", 43.3543, 77.0428, "almaty international airport almaty alma ata алматы алма-ата"],
  ...
  ["ALG", "Houari Boumediene Airport", "Algiers", "Algeria", "Africa/Algiers", 36.6939, 3.2145, "houari boumediene airport algiers alger el djazair الجزائر алжир"],
  ["ALP", "Aleppo International Airport", "Aleppo", "Syria", "Asia/Damascus", 36.1813, 37.2269],
  ["AMD", "Sardar Vallabh Patel International Airport", "Ahmedabad", "India", "Asia/Kolkata", 23.0772, 72.6347, "sardar vallabh patel international airport ahmedabad amdavad अहमदाबाद અમદાવાદ"],
  ...
  ["AMS", "Amsterdam Airport Schiphol", "Amsterdam", "Netherlands", "Europe/Amsterdam", 52.3086, 4.7639, "amsterdam airport schiphol amsterdam amsterda амстердам アムステルダム 阿姆斯特丹 암스테르담"],
  ...
  ["ASB", "Ashgabat International Airport", "Ashgabat", "Turkmenistan", "Asia/Ashgabat", 37.9868, 58.3610, "ashgabat international airport ashgabat ashkhabad ашхабад"],
  ...
  ["ATH", "Athens Eleftherios Venizelos International Airport", "Spata-Artemida", "Greece", "Europe/Athens", 37.9364, 23.9445, "athens eleftherios venizelos international airport spata artemida athina atenas atene αθήνα афины アテネ 雅典 아테네"],
  ["ATL", "Hartsfield Jackson Atlanta International Airport", "Atlanta", "United States", "America/New_York", 33.6367, -84.4281, "hartsfield jackson atlanta international airport atlanta атланта アトランタ 亚特兰大"],
  ["ATQ", "Sri Guru Ram Das Ji International Airport", "Amritsar", "India", "Asia/Kolkata", 31.7096, 74.7973, "sri guru ram das ji international airport amritsar अमृतसर ਅੰਮ੍ਰਿਤਸਰ"],
  ...
  ["AUH", "Zayed International Airport", "Abu Dhabi", "United Arab Emirates", "Asia/Dubai", 24.4410, 54.6492, "zayed international airport abu dhabi abudhabi أبو ظبي абу-даби अबू धाबी アブダビ 阿布扎比 아부다비"],
  ...
  ["AYT", "Antalya International Airport", "Antalya", "Turkey", "Europe/Istanbul", 36.8987, 30.8005, "antalya international airport antalya анталия анталья"],
  ["BAH", "Bahrain International Airport", "Manama", "Bahrain", "Asia/Bahrain", 26.2673, 50.6376, "bahrain international airport manama المنامة البحرين бахрейн बहरीन"],
  ...
  ["BBI", "Biju Patnaik International Airport", "Bhubaneswar", "India", "Asia/Kolkata", 20.2510, 85.8147, "biju patnaik international airport bhubaneswar भुवनेश्वर"],
  ...
  ["BCN", "Josep Tarradellas Barcelona-El Prat Airport", "Barcelona", "Spain", "Europe/Madrid", 41.2971, 2.0785, "josep tarradellas barcelona el prat airport barcelona barna barcelone barcellona барселона バルセロナ 巴塞罗那 바르셀로나 برشلونة"],
  ...
  ["BDQ", "Vadodara International Airport", "Vadodara", "India", "Asia/Kolkata", 22.3362, 73.2263, "vadodara international airport vadodara baroda वडोदरा"],
  ["BDS", "Brindisi Airport", "Brindisi", "Italy", "Europe/Rome", 40.6576, 17.9470],
  ["BEG", "Belgrade Nikola Tesla Airport", "Belgrade", "Serbia", "Europe/Belgrade", 44.8184, 20.3091, "belgrade nikola tesla airport belgrade beograd belgrado белград"],
  ...
  ["BER", "Berlin Brandenburg Airport", "Berlin", "Germany", "Europe/Berlin", 52.3617, 13.5023, "berlin brandenburg airport berlin berlim берлин ベルリン 柏林 베를린 برلين"],
  ...
  ["BEY", "Beirut Rafic Hariri International Airport", "Beirut", "Lebanon", "Asia/Beirut", 33.8198, 35.4874, "beirut rafic hariri international airport beirut bayrut beyrouth بيروت бейрут ベイルート 贝鲁特"],
  ...
  ["BGO", "Bergen Airport, Flesland", "Bergen", "Norway", "Europe/Oslo", 60.2934, 5.2181, "bergen airport flesland bergen бэрген"],
  ["BGW", "Baghdad International Airport / New Al Muthana Air Base", "Baghdad", "Iraq", "Asia/Baghdad", 33.2625, 44.2346, "baghdad international airport new al muthana air base baghdad bagdad بغداد багдад"],
  ...
  ["BHK", "Bukhara International Airport", "Bukhara", "Uzbekistan", "Asia/Samarkand", 39.7753, 64.4823, "bukhara international airport bukhara buxoro бухара"],
  ["BHM", "Birmingham-Shuttlesworth International Airport", "Birmingham", "United States", "America/Chicago", 33.5629, -86.7507],
  ["BHO", "Raja Bhoj International Airport", "Bhopal", "India", "Asia/Kolkata", 23.2875, 77.3374, "raja bhoj international airport bhopal भोपाल"],
  ...
  ["BIO", "Bilbao Airport", "Bilbao", "Spain", "Europe/Madrid", 43.3011, -2.9106, "bilbao airport bilbao bilbo"],
  ...
  ["BKI", "Kota Kinabalu International Airport", "Kota Kinabalu", "Malaysia", "Asia/Kuching", 5.9327, 116.0493, "kota kinabalu international airport kota kinabalu jesselton"],
  ...
  ["BLQ", "Bologna Guglielmo Marconi Airport", "Bologna", "Italy", "Europe/Rome", 44.5354, 11.2887, "bologna guglielmo marconi airport bologna bolonia bologne"],
  ["BLR", "Kempegowda International Airport Bengaluru", "Bengaluru", "India", "Asia/Kolkata", 13.1979, 77.7063, "kempegowda international airport bengaluru bengaluru bangalore बेंगलुरु बैंगलोर ಬೆಂಗಳೂರು 班加罗尔"],
  ...
  ["BNE", "Brisbane International Airport", "Brisbane", "Australia", "Australia/Brisbane", -27.3842, 153.1170, "brisbane international airport brisbane brissie брисбен"],
  ...
  ["BOG", "El Dorado International Airport", "Bogota", "Colombia", "America/Bogota", 4.7016, -74.1469, "el dorado international airport bogota богота ボゴタ 波哥大"],
  ...
  ["BOM", "Chhatrapati Shivaji Maharaj International Airport", "Mumbai", "India", "Asia/Kolkata", 19.0887, 72.8679, "chhatrapati shivaji maharaj international airport mumbai bombay मुंबई बंबई ムンバイ 孟买 뭄바이 مومباي"],
  ...
  ["BOS", "Boston Logan International Airport", "Boston", "United States", "America/New_York", 42.3620, -71.0079, "boston logan international airport boston бостон ボストン 波士顿 보스턴"],
  ...
  ["BRU", "Brussels Airport", "Brussels", "Belgium", "Europe/Brussels", 50.9014, 4.4844, "brussels airport brussels zaventem bruxelles brussel bruselas брюссель ブリュッセル 布鲁塞尔 브뤼셀"],
  ["BSA", "Bender Qassim International Airport", "Bosaso", "Somalia", "Africa/Mogadishu", 11.2752, 49.1392],
  ["BSB", "Presidente Juscelino Kubitschek International Airport", "Brasília", "Brazil", "America/Sao_Paulo", -15.8692, -47.9208, "presidente juscelino kubitschek international airport brasília presidente juscelino kubitschek international airport brasilia бразилиа"],
  ...
  ["BSL", "EuroAirport Basel–Mulhouse–Freiburg", "Bâle / Mulhouse", "France", "Europe/Paris", 47.6007, 7.5211, "euroairport basel mulhouse freiburg bâle mulhouse euroairport basel mulhouse freiburg bale mulhouse basle basilea"],
  ["BSR", "Basra International Airport", "Basra", "Iraq", "Asia/Baghdad", 30.5491, 47.6621, "basra international airport basra basrah البصرة"],
  ...
  ["BTS", "M. R. Štefánik Airport", "Bratislava", "Slovakia", "Europe/Bratislava", 48.1702, 17.2127, "m r štefánik airport bratislava m r stefanik airport bratislava pressburg pozsony братислава"],
  ["BUD", "Budapest Liszt Ferenc International Airport", "Budapest", "Hungary", "Europe/Budapest", 47.4302, 19.2624, "budapest liszt ferenc international airport budapest budapeste будапешт ブダペスト 布达佩斯 부다페스트"],
  ...
  ["CAI", "Cairo International Airport", "Cairo", "Egypt", "Africa/Cairo", 30.1115, 31.3967, "cairo international airport cairo al qahirah al qahira el cairo le caire kairo القاهرة каир カイロ 开罗 काहिरा 카이로"],
  ["CAN", "Guangzhou Baiyun International Airport", "Guangzhou", "China", "Asia/Shanghai", 23.3924, 113.2990, "guangzhou baiyun international airport guangzhou huadu canton kwangchow 广州 廣州 гуанчжоу 광저우"],
  ...
  ["CCU", "Netaji Subhash Chandra Bose International Airport", "Kolkata", "India", "Asia/Kolkata", 22.6540, 88.4476, "netaji subhash chandra bose international airport kolkata calcutta kalkutta कोलकाता কলকাতা 加尔各答"],
  ...
  ["CGN", "Cologne Bonn Airport", "Köln", "Germany", "Europe/Berlin", 50.8659, 7.1427, "cologne bonn airport köln cologne bonn airport koln colonia keulen кёльн ケルン 科隆 쾰른"],
  ["CGO", "Zhengzhou Xinzheng International Airport", "Zhengzhou", "China", "Asia/Shanghai", 34.5265, 113.8492],
  ["CGP", "Shah Amanat International Airport", "Chattogram", "Bangladesh", "Asia/Dhaka", 22.2496, 91.8133, "shah amanat international airport chattogram chittagong চট্টগ্রাম"],
  ...
  ["CHC", "Christchurch International Airport", "Christchurch", "New Zealand", "Pacific/Auckland", -43.4890, 172.5321, "christchurch international airport christchurch otautahi"],
  ...
  ["CJB", "Coimbatore International Airport", "Coimbatore", "India", "Asia/Kolkata", 11.0300, 77.0434, "coimbatore international airport coimbatore कोयंबटूर கோயம்புத்தூர்"],
  ...
  ["CJU", "Jeju International Airport", "Jeju City", "South Korea", "Asia/Seoul", 33.5121, 126.4925, "jeju international airport jeju city cheju 제주"],
  ["CKG", "Chongqing Jiangbei International Airport", "Chongqing", "China", "Asia/Shanghai", 29.7123, 106.6519, "chongqing jiangbei international airport chongqing chungking 重庆"],
  ...
  ["CMN", "Mohammed V International Airport", "Casablanca", "Morocco", "Africa/Casablanca", 33.3675, -7.5900, "mohammed v international airportblanca casa dar el beida الدار البيضاء касабланка"],
  ...
  ["CNF", "Tancredo Neves International Airport", "Belo Horizonte", "Brazil", "America/Sao_Paulo", -19.6357, -43.9669, "tancredo neves international airport belo horizonte beaga confins"],
  ...
  ["CNX", "Chiang Mai International Airport", "Chiang Mai", "Thailand", "Asia/Bangkok", 18.7668, 98.9626, "chiang mai international airport chiang mai chiangmai เชียงใหม่"],
  ["COK", "Cochin International Airport", "Kochi", "India", "Asia/Kolkata", 10.1510, 76.4008, "cochin international airport kochi कोच्चि കൊച്ചി"],
  ...
  ["CPH", "Copenhagen Kastrup Airport", "Copenhagen", "Denmark", "Europe/Copenhagen", 55.6179, 12.6560, "copenhagen kastrup airport copenhagen kobenhavn kopenhagen copenhague copenaghen копенгаген コペンハーゲン 哥本哈根 코펜하겐"],
  ["CPT", "Cape Town International Airport", "Cape Town", "South Africa", "Africa/Johannesburg", -33.9740, 18.6043, "cape town international airport cape town kaapstad capetown кейптаун ケープタウン 开普敦 케이프타운"],
  ...
  ["CSX", "Changsha Huanghua International Airport", "Changsha", "China", "Asia/Shanghai", 28.1892, 113.2200, "changsha huanghua international airport changsha 长沙"],
  ...
  ["CTS", "New Chitose Airport", "Sapporo", "Japan", "Asia/Tokyo", 42.7748, 141.6904, "new chitose airport sapporo 札幌 新千歳 삿포로"],
  ["CTU", "Chengdu Shuangliu International Airport", "Chengdu", "China", "Asia/Shanghai", 30.5583, 103.9460, "chengdu shuangliu international airport chengdu 成都"],
  ...
  ["CUN", "Cancún International Airport", "Cancún", "Mexico", "America/Cancun", 21.0408, -86.8735, "cancún international airport cancún cancun international airport cancun канкун カンクン 坎昆"],
  ["CUR", "Hato International Airport", "Willemstad", "Curaçao", "America/Curacao", 12.1889, -68.9598, "hato international airport willemstad curacao"],
  ["CUU", "General Roberto Fierro Villalobos International Airport", "Chihuahua", "Mexico", "America/Chihuahua", 28.7026, -105.9638],
  ["CUZ", "Alejandro Velasco Astete International Airport", "Cusco", "Peru", "America/Lima", -13.5357, -71.9388, "alejandro velasco astete international airport cusco cuzco"],
  ...
  ["DAC", "Hazrat Shahjalal International Airport", "Dhaka", "Bangladesh", "Asia/Dhaka", 23.8433, 90.3978, "hazrat shahjalal international airport dhaka dacca ঢাকা ढाका дакка"],
  ["DAD", "Da Nang International Airport", "Da Nang", "Vietnam", "Asia/Ho_Chi_Minh", 16.0439, 108.1990, "da nang international airport da nang danang"],
  ["DAL", "Dallas Love Field", "Dallas", "United States", "America/Chicago", 32.8448, -96.8477],
  ["DAM", "Damascus International Airport", "Damascus", "Syria", "Asia/Damascus", 33.4115, 36.5156, "damascus international airport damascus dimashq damas دمشق дамаск"],
  ...
  ["DBV", "Dubrovnik Ruđer Bošković Airport", "Dubrovnik", "Croatia", "Europe/Zagreb", 42.5622, 18.2655, "dubrovnik ruđer bošković airport dubrovnik dubrovnik ruđer boskovic airport dubrovnik ragusa"],
  ...
  ["DED", "Dehradun Jolly Grant Airport", "Dehradun", "India", "Asia/Kolkata", 30.1892, 78.1767, "dehradun jolly grant airport dehradun jauligrant देहरादून"],
  ["DEL", "Indira Gandhi International Airport", "New Delhi", "India", "Asia/Kolkata", 28.5556, 77.0952, "indira gandhi international airport new delhi deli dilli दिल्ली नई दिल्ली デリー 新德里 델리 دلهي"],
  ["DEN", "Denver International Airport", "Denver", "United States", "America/Denver", 39.8600, -104.6738, "denver international airport denver денвер デンバー 丹佛"],
  ["DFW", "Dallas Fort Worth International Airport", "Dallas-Fort Worth", "United States", "America/Chicago", 32.8968, -97.0380, "dallas fort worth international airport dallas fort worth даллас ダラス 达拉斯"],
  ...
  ["DIB", "Dibrugarh Airport", "Dibrugarh", "India", "Asia/Kolkata", 27.4839, 95.0169, "dibrugarh airport dibrugarh डिब्रूगढ़"],
  ...
  ["DJE", "Djerba Zarzis International Airport", "Mellita", "Tunisia", "Africa/Tunis", 33.8737, 10.7773, "djerba zarzis international airport mellita جربة"],
  ...
  ["DLC", "Dalian Zhoushuizi International Airport", "Dalian", "China", "Asia/Shanghai", 38.9657, 121.5385, "dalian zhoushuizi international airport dalian ganjingzi 大连"],
  ...
  ["DMK", "Don Mueang International Airport", "Bangkok", "Thailand", "Asia/Bangkok", 13.9126, 100.6070, "don mueang international airport bangkok don muang ดอนเมือง"],
  ["DMM", "King Fahd International Airport", "Ad Dammam", "Saudi Arabia", "Asia/Riyadh", 26.4691, 49.7982, "king fahd international airport ad dammam الدمام"],
  ...
  ["DPS", "Denpasar I Gusti Ngurah Rai International Airport", "Denpasar", "Indonesia", "Asia/Makassar", -8.7484, 115.1671, "denpasar i gusti ngurah rai international airport denpasar badung kuta bali 巴厘岛 бали バリ 발리"],
  ...
  ["DSS", "Blaise Diagne International Airport", "Dakar", "Senegal", "Africa/Dakar", 14.6709, -17.0728, "blaise diagne international airport dakar دكار"],
  ...
  ["DUB", "Dublin Airport", "Dublin", "Ireland", "Europe/Dublin", 53.4287, -6.2621, "dublin airport dublin baile atha cliath дублин ダブリン 都柏林 더블린"],
  ["DUR", "King Shaka International Airport", "Durban", "South Africa", "Africa/Johannesburg", -29.6144, 31.1197, "king shaka international airport durban ethekwini"],
  ["DUS", "Düsseldorf Airport", "Düsseldorf", "Germany", "Europe/Berlin", 51.2895, 6.7668, "düsseldorf airport düsseldorf dusseldorf airport dusseldorf duesseldorf дюссельдорф デュッセルドルフ 杜塞尔多夫"],
  ...
  ["DYU", "Dushanbe International Airport", "Dushanbe", "Tajikistan", "Asia/Dushanbe", 38.5437, 68.8230, "dushanbe international airport dushanbe душанбе"],
  ...
  ["EBB", "Entebbe International Airport", "Entebbe", "Uganda", "Africa/Kampala", 0.0424, 32.4435, "entebbe international airport entebbe kampala кампала"],
  ["EBL", "Erbil International Airport", "Arbil", "Iraq", "Asia/Baghdad", 36.2360, 43.9466, "erbil international airport arbil hawler أربيل"],
  ["ECN", "Ercan International Airport", "Tymbou", "Cyprus", "Asia/Famagusta", 35.1531, 33.5074, "ercan international airport tymbou kirklar"],
  ["EDI", "Edinburgh Airport", "Edinburgh", "United Kingdom", "Europe/London", 55.9501, -3.3723, "edinburgh airport edinburgh ingliston edimburgo edimbourg эдинбург エディンバラ"],
  ...
  ["ESB", "Esenboğa International Airport", "Ankara", "Turkey", "Europe/Istanbul", 40.1281, 32.9951, "esenboğa international airport ankara esenboga international airport ankara анкара أنقرة アンカラ"],
  ...
  ["EVN", "Zvartnots International Airport", "Yerevan", "Armenia", "Asia/Yerevan", 40.1489, 44.3979, "zvartnots international airport yerevan erevan ереван երևան"],
  ...
  ["FEZ", "Fes Saïss International Airport", "Saïss", "Morocco", "Africa/Casablanca", 33.9273, -4.9780, "fes saïss international airport saïss fes saiss international airport saiss فاس"],
  ["FIH", "Ndjili International Airport", "Kinshasa", "Democratic Republic of the Congo", "Africa/Kinshasa", -4.3857, 15.4446, "ndjili international airport kinshasa leopoldville"],
  ...
  ["FLN", "Hercílio Luz International Airport", "Florianópolis", "Brazil", "America/Sao_Paulo", -27.6703, -48.5525, "hercílio luz international airport florianópolis hercilio luz international airport florianopolis floripa"],
  ["FLR", "Florence Airport, Peretola", "Firenze", "Italy", "Europe/Rome", 43.8086, 11.2028, "florence airport peretola firenze fi florenz florencia флоренция フィレンツェ 佛罗伦萨 피렌체"],
  ...
  ["FNJ", "Pyongyang Sunan International Airport", "Pyongyang", "North Korea", "Asia/Pyongyang", 39.2241, 125.6700, "pyongyang sunan international airport pyongyang 평양"],
  ...
  ["FRA", "Frankfurt Main Airport", "Frankfurt am Main", "Germany", "Europe/Berlin", 50.0267, 8.5584, "frankfurt main airport frankfurt am main francfort francoforte франкфурт フランクフルト 法兰克福 프랑크푸르트"],
  ...
  ["FUK", "Fukuoka Airport", "Fukuoka", "Japan", "Asia/Tokyo", 33.5859, 130.4510, "fukuoka airport fukuoka 福岡 hakata 후쿠오카"],
  ["GAN", "Gan International Airport", "Gan", "Maldives", "Indian/Maldives", -0.6930, 73.1526],
  ["GAU", "Lokpriya Gopinath Bordoloi International Airport", "Guwahati", "India", "Asia/Kolkata", 26.1067, 91.5852, "lokpriya gopinath bordoloi international airport guwahati gauhati गुवाहाटी"],
  ...
  ["GDN", "Gdańsk Lech Wałęsa Airport", "Gdańsk", "Poland", "Europe/Warsaw", 54.3776, 18.4662, "gdańsk lech wałęsa airport gdańsk gdansk lech wałesa airport gdansk danzig"],
  ...
  ["GMP", "Seoul Gimpo International Airport", "Seoul", "South Korea", "Asia/Seoul", 37.5583, 126.7910, "seoul gimpo international airport seoul 김포"],
  ...
  ["GOT", "Göteborg Landvetter Airport", "Göteborg", "Sweden", "Europe/Stockholm", 57.6628, 12.2798, "göteborg landvetter airport göteborg gothenburg goteborg landvetter airport goteborg gothenburg gotemburgo"],
  ...
  ["GUA", "La Aurora International Airport", "Guatemala City", "Guatemala", "America/Guatemala", 14.5829, -90.5275, "la aurora international airport guatemala city ciudad de guatemala"],
  ...
  ["GVA", "Geneva International Airport", "Geneva", "Switzerland", "Europe/Paris", 46.2381, 6.1090, "geneva international airport geneva geneve genf ginevra ginebra женева ジュネーブ 日内瓦 제네바"],
  ...
  ["GYD", "Heydar Aliyev International Airport", "Baku", "Azerbaijan", "Asia/Baku", 40.4728, 50.0509, "heydar aliyev international airport baku bakı баку"],
  ...
  ["HAK", "Haikou Meilan International Airport", "Haikou", "China", "Asia/Shanghai", 19.9349, 110.4590, "haikou meilan international airport haikou 海口"],
  ["HAM", "Hamburg Helmut Schmidt Airport", "Hamburg", "Germany", "Europe/Berlin", 53.6304, 9.9882, "hamburg helmut schmidt airport hamburg hamburgo hambourg гамбург ハンブルク 汉堡 함부르크"],
  ["HAN", "Noi Bai International Airport", "Hanoi", "Vietnam", "Asia/Bangkok", 21.2212, 105.8070, "noi bai international airport hanoi soc son ha noi 河内 ханой ハノイ 하노이"],
  ...
  ["HAV", "José Martí International Airport", "Havana", "Cuba", "America/Havana", 22.9892, -82.4091, "josé martí international airport havana jose marti international airport havana la habana гавана ハバナ 哈瓦那"],
  ...
  ["HBE", "Alexandria International Airport", "Alexandria", "Egypt", "Africa/Cairo", 30.9325, 29.6964, "alexandria international airport alexandria iskandariya الإسكندرية"],
  ...
  ["HDY", "Hat Yai International Airport", "Hat Yai", "Thailand", "Asia/Bangkok", 6.9332, 100.3930, "hat yai international airport hat yai hatyai หาดใหญ่"],
  ["HEA", "Herat - Khwaja Abdullah Ansari International Airport", "Guzara", "Afghanistan", "Asia/Kabul", 34.2100, 62.2283],
  ["HEL", "Helsinki Vantaa Airport", "Helsinki", "Finland", "Europe/Helsinki", 60.3184, 24.9633, "helsinki vantaa airport helsinki helsingfors хельсинки ヘルシンキ 赫尔辛基 헬싱키"],
  ...
  ["HGH", "Hangzhou Xiaoshan International Airport", "Hangzhou", "China", "Asia/Shanghai", 30.2361, 120.4289, "hangzhou xiaoshan international airport hangzhou 杭州"],
  ...
  ["HIJ", "Hiroshima Airport", "Hiroshima", "Japan", "Asia/Tokyo", 34.4361, 132.9190, "hiroshima airport hiroshima 広島"],
  ...
  ["HKT", "Phuket International Airport", "Phuket", "Thailand", "Asia/Bangkok", 8.1133, 98.3174, "phuket international airport phuket ภูเก็ต пхукет プーケット 普吉"],
  ...
  ["HND", "Tokyo Haneda International Airport", "Tokyo", "Japan", "Asia/Tokyo", 35.5497, 139.7870, "tokyo haneda international airport tokyo 羽田"],
  ["HNL", "Daniel K. Inouye International Airport", "Honolulu", "United States", "Pacific/Honolulu", 21.3184, -157.9257, "daniel k inouye international airport honolulu oahu гонолулу ホノルル 檀香山"],
  ...
  ["HRB", "Harbin Taiping International Airport", "Harbin", "China", "Asia/Shanghai", 45.6234, 126.2500, "harbin taiping international airport harbin 哈尔滨"],
  ["HRE", "Robert Gabriel Mugabe International Airport", "Harare", "Zimbabwe", "Africa/Harare", -17.9318, 31.0928, "robert gabriel mugabe international airport harare salisbury"],
  ["HRG", "Hurghada International Airport", "Hurghada", "Egypt", "Africa/Cairo", 27.1768, 33.7967, "hurghada international airport hurghada al ghardaqah الغردقة хургада"],
  ...
  ["HSR", "Rajkot International Airport", "Rajkot", "India", "Asia/Kolkata", 22.3788, 71.0394, "rajkot international airport rajkot hirasar राजकोट"],
  ...
  ["HYD", "Rajiv Gandhi International Airport", "Hyderabad", "India", "Asia/Kolkata", 17.2313, 78.4299, "rajiv gandhi international airport hyderabad shamshabad secunderabad हैदराबाद హైదరాబాద్ 海得拉巴"],
  ...
  ["ICN", "Incheon International Airport", "Seoul", "South Korea", "Asia/Seoul", 37.4691, 126.4510, "incheon international airport seoul 인천 仁川"],
  ["IDR", "Devi Ahilya Bai Holkar International Airport", "Indore", "India", "Asia/Kolkata", 22.7214, 75.8005, "devi ahilya bai holkar international airport indore इंदौर"],
  ["IFN", "Isfahan Shahid Beheshti International Airport", "Isfahan", "Iran", "Asia/Tehran", 32.7551, 51.8839, "isfahan shahid beheshti international airport isfahan esfahan اصفهان"],
  ...
  ["IMF", "Bir Tikendrajit International Airport", "Imphal", "India", "Asia/Kolkata", 24.7600, 93.8967, "bir tikendrajit international airport imphal इंफाल"],
  ...
  ["ISB", "Islamabad International Airport", "Attock", "Pakistan", "Asia/Karachi", 33.5490, 72.8257, "islamabad international airport attock اسلام آباد इस्लामाबाद"],
  ...
  ["ITM", "Osaka Itami International Airport", "Osaka", "Japan", "Asia/Tokyo", 34.7809, 135.4408, "osaka itami international airport osaka 伊丹"],
  ["IVL", "Ivalo Airport", "Ivalo", "Finland", "Europe/Helsinki", 68.6073, 27.4053],
  ["IXA", "Agartala - Maharaja Bir Bikram Airport", "Agartala", "India", "Asia/Kolkata", 23.8870, 91.2404, "agartala maharaja bir bikram airport agartala अगरतला"],
  ["IXB", "Bagdogra Airport", "Siliguri", "India", "Asia/Kolkata", 26.6812, 88.3286, "bagdogra airport siliguri बागडोगरा सिलीगुड़ी"],
  ["IXC", "Shaheed Bhagat Singh International Airport", "Chandigarh", "India", "Asia/Kolkata", 30.6735, 76.7885, "shaheed bhagat singh international airport chandigarh चंडीगढ़"],
  ["IXD", "Prayagraj Airport", "Allahabad", "India", "Asia/Kolkata", 25.4401, 81.7339, "prayagraj airport allahabad प्रयागराज"],
  ["IXE", "Mangaluru International Airport", "Mangaluru", "India", "Asia/Kolkata", 12.9547, 74.8868, "mangaluru international airport mangaluru mangalore मंगलुरु"],
  ...
  ["IXJ", "Jammu Airport", "Jammu", "India", "Asia/Kolkata", 32.6888, 74.8382, "jammu airport jammu जम्मू"],
  ["IXK", "Keshod Airport", "Keshod", "India", "Asia/Kolkata", 21.3171, 70.2704],
  ["IXL", "Leh Kushok Bakula Rimpochee Airport", "Leh", "India", "Asia/Kolkata", 34.1359, 77.5465, "leh kushok bakula rimpochee airport leh लेह"],
  ...
  ["IXR", "Birsa Munda Airport", "Ranchi", "India", "Asia/Kolkata", 23.3143, 85.3217, "birsa munda airport ranchi रांची"],
  ["IXS", "Silchar Airport", "Silchar", "India", "Asia/Kolkata", 24.9129, 92.9787],
  ["IXU", "Aurangabad Airport", "Aurangabad", "India", "Asia/Kolkata", 19.8629, 75.3963, "aurangabad airport aurangabad sambhajinagar chhatrapati sambhajinagar औरंगाबाद"],
  ["IXY", "Kandla Airport", "Kandla", "India", "Asia/Kolkata", 23.1127, 70.1003],
  ["IXZ", "Veer Savarkar International Airport / INS Utkrosh", "Port Blair", "India", "Asia/Kolkata", 11.6402, 92.7290, "veer savarkar international airport ins utkrosh port blair पोर्ट ब्लेयर"],
  ["JAF", "Jaffna International Airport", "Jaffna", "Sri Lanka", "Asia/Colombo", 9.7923, 80.0701],
  ["JAI", "Jaipur International Airport", "Jaipur", "India", "Asia/Kolkata", 26.8242, 75.8122, "jaipur international airport jaipur जयपुर"],
  ...
  ["JDH", "Jodhpur Airport", "Jodhpur", "India", "Asia/Kolkata", 26.2511, 73.0489, "jodhpur airport jodhpur जोधपुर"],
  ["JED", "King Abdulaziz International Airport", "Jeddah", "Saudi Arabia", "Asia/Riyadh", 21.6802, 39.1574, "king abdulaziz international airport jeddah jidda jiddah djeddah جدة джидда जेद्दा ジッダ 吉达"],
  ...
  ["JRO", "Kilimanjaro International Airport", "Arusha", "Tanzania", "Africa/Dar_es_Salaam", -3.4270, 37.0735, "kilimanjaro international airport arusha moshi"],
  ...
  ["KBL", "Kabul International Airport", "Kabul", "Afghanistan", "Asia/Kabul", 34.5659, 69.2123, "kabul international airport kabul kabol کابل कабул"],
  ["KBV", "Krabi International Airport", "Krabi", "Thailand", "Asia/Bangkok", 8.0956, 98.9890, "krabi international airport krabi กระบี่"],
  ...
  ["KEF", "Keflavik International Airport", "Reykjavík", "Iceland", "Atlantic/Reykjavik", 63.9850, -22.6056, "keflavik international airport reykjavík reykjavik keflavik international airport reykjavik reykjavik рейкьявик"],
  ...
  ["KHH", "Kaohsiung International Airport", "Kaohsiung", "Taiwan", "Asia/Taipei", 22.5771, 120.3500, "kaohsiung international airport kaohsiung xiaogang 高雄 gaoxiong"],
  ["KHI", "Jinnah International Airport", "Karachi", "Pakistan", "Asia/Karachi", 24.9065, 67.1608, "jinnah international airport karachi کراچی карачи कराची"],
  ...
  ["KIX", "Kansai International Airport", "Osaka", "Japan", "Asia/Tokyo", 34.4273, 135.2440, "kansai international airport osaka 関西"],
  ...
  ["KMG", "Kunming Changshui International Airport", "Kunming", "China", "Asia/Shanghai", 25.1103, 102.9367, "kunming changshui international airport kunming 昆明"],
  ...
  ["KNO", "Kualanamu International Airport", "Beringin", "Indonesia", "Asia/Jakarta", 3.6378, 98.8706, "kualanamu international airport beringin medan"],
  ...
  ["KOJ", "Kagoshima Airport", "Kagoshima", "Japan", "Asia/Tokyo", 31.8034, 130.7190, "kagoshima airport kagoshima 鹿児島"],
  ...
  ["KRK", "Kraków John Paul II International Airport", "Balice", "Poland", "Europe/Warsaw", 50.0777, 19.7848, "kraków john paul ii international airport balice krakow john paul ii international airport balice cracow cracovia krakau краков"],
  ["KRN", "Kiruna Airport", "Kiruna", "Sweden", "Europe/Stockholm", 67.8220, 20.3368],
  ["KRR", "Krasnodar Pashkovsky International Airport", "Krasnodar", "Russia", "Europe/Moscow", 45.0345, 39.1742, "krasnodar pashkovsky international airport krasnodar краснодар"],
  ["KRS", "Kristiansand Airport", "Kristiansand", "Norway", "Europe/Oslo", 58.2042, 8.0854, "kristiansand airport kristiansand kjevik"],
  ["KRT", "Khartoum International Airport", "Khartoum", "Sudan", "Africa/Khartoum", 15.5895, 32.5532, "khartoum international airport khartoum al khartum الخرطوم хартум"],
  ...
  ["KTI", "Techo International Airport", "Phnom Penh", "Cambodia", "Asia/Phnom_Penh", 11.3600, 104.9213, "techo international airport phnom penh boeng khyang ភ្នំពេញ пномпень 金边"],
  ["KTM", "Tribhuvan International Airport", "Kathmandu", "Nepal", "Asia/Kathmandu", 27.6966, 85.3591, "tribhuvan international airport kathmandu katmandu काठमाडौँ काठमांडू катманду"],
  ...
  ["KWI", "Kuwait International Airport", "Kuwait City", "Kuwait", "Asia/Kuwait", 29.2245, 47.9698, "kuwait international airport kuwait city الكويت кувейт कुवैत クウェート 科威特"],
  ...
  ["KZN", "Kazan International Airport", "Kazan", "Russia", "Europe/Moscow", 55.6062, 49.2787, "kazan international airport kazan казань"],
  ...
  ["LAS", "Harry Reid International Airport", "Las Vegas", "United States", "America/Los_Angeles", 36.0834, -115.1518, "harry reid international airport las vegas лас-вегас ラスベガス 拉斯维加斯 라스베이거스"],
  ...
  ["LCA", "Larnaca International Airport", "Larnaca", "Cyprus", "Asia/Nicosia", 34.8751, 33.6249, "larnaca international airport larnaca larnaka λάρνακα"],
  ...
  ["LED", "Pulkovo Airport", "St. Petersburg", "Russia", "Europe/Moscow", 59.8003, 30.2625, "pulkovo airport st petersburg saint petersburg sankt peterburg leningrad piter санкт-петербург питер"],
  ["LEJ", "Leipzig/Halle Airport", "Leipzig", "Germany", "Europe/Berlin", 51.4207, 12.2327, "leipzig halle airport leipzig schkeuditz лейпциг"],
  ...
  ["LHE", "Allama Iqbal International Airport", "Lahore", "Pakistan", "Asia/Karachi", 31.5216, 74.4036, "allama iqbal international airport lahore لاہور लाहौर"],
  ...
  ["LIM", "Jorge Chávez International Airport", "Lima", "Peru", "America/Lima", -12.0219, -77.1143, "jorge chávez international airport lima jorge chavez international airport lima лима リマ 利马"],
  ...
  ["LIS", "Lisbon Humberto Delgado Airport", "Lisbon", "Portugal", "Europe/Lisbon", 38.7813, -9.1359, "lisbon humberto delgado airport lisbon lisboa lissabon lisbonne лиссабон リスボン 里斯本 리스본"],
  ["LJG", "Lijiang Sanyi International Airport", "Lijiang", "China", "Asia/Shanghai", 26.6775, 100.2449],
  ["LJU", "Ljubljana Jože Pučnik Airport", "Zgornji Brnik", "Slovenia", "Europe/Ljubljana", 46.2237, 14.4576, "ljubljana jože pučnik airport zgornji brnik ljubljana joze pucnik airport zgornji brnik laibach любляна"],
  ["LKO", "Chaudhary Charan Singh International Airport", "Lucknow", "India", "Asia/Kolkata", 26.7606, 80.8893, "chaudhary charan singh international airport lucknow लखनऊ"],
  ...
  ["LOS", "Murtala Muhammed International Airport", "Lagos", "Nigeria", "Africa/Lagos", 6.5774, 3.3212, "murtala muhammed international airport lagos eko лагос"],
  ...
  ["LUX", "Luxembourg-Findel International Airport", "Luxembourg", "Luxembourg", "Europe/Luxembourg", 49.6268, 6.2121, "luxembourg findel international airport luxembourg luxemburgo lussemburgo luxemburg"],
  ...
  ["LXA", "Lhasa Gonggar International Airport", "Shannan", "China", "Asia/Shanghai", 29.2980, 90.9120, "lhasa gonggar international airport shannan 拉萨"],
  ["LXR", "Luxor International Airport", "Luxor", "Egypt", "Africa/Cairo", 25.6710, 32.7064, "luxor international airport luxor الأقصر"],
  ...
  ["LYS", "Lyon Saint-Exupéry Airport", "Lyon", "France", "Europe/Paris", 45.7260, 5.0901, "lyon saint exupéry airport lyon rhône colombier saugnieu lyon saint exupery airport lyon rhone colombier saugnieu lione лион"],
  ["MAA", "Chennai International Airport", "Chennai", "India", "Asia/Kolkata", 12.9900, 80.1693, "chennai international airport chennai madras चेन्नई சென்னை 钦奈"],
  ["MAD", "Adolfo Suárez Madrid–Barajas Airport", "Madrid", "Spain", "Europe/Madrid", 40.4934, -3.5722, "adolfo suárez madrid barajas airport madrid adolfo suarez madrid barajas airport madrid madri мадрид マドリード 马德里 마드리드 مدريد"],
  ...
  ["MAN", "Manchester Airport", "Manchester", "United Kingdom", "Europe/London", 53.3494, -2.2795, "manchester airport manchester greater манчестер マンチェスター 曼彻斯特"],
  ...
  ["MBJ", "Sangster International Airport", "Montego Bay", "Jamaica", "America/Jamaica", 18.5034, -77.9132, "sangster international airport montego bay mobay"],
  ["MCI", "Kansas City International Airport", "Kansas City", "United States", "America/Chicago", 39.3017, -94.7139],
  ["MCO", "Orlando International Airport", "Orlando", "United States", "America/New_York", 28.4294, -81.3090, "orlando international airport orlando орландо オーランド 奥兰多"],
  ["MCT", "Muscat International Airport", "Muscat/Seeb", "Oman", "Asia/Muscat", 23.6002, 58.2853, "muscat international airport muscat seeb masqat مسقط маскат मस्कट マスカット 马斯喀特"],
  ...
  ["MDE", "Jose Maria Córdova International Airport", "Medellín", "Colombia", "America/Bogota", 6.1645, -75.4231, "jose maria córdova international airport medellín jose maria cordova international airport medellin rionegro"],
  ...
  ["MED", "Prince Mohammad Bin Abdulaziz Airport", "Medina", "Saudi Arabia", "Asia/Riyadh", 24.5534, 39.7051, "prince mohammad bin abdulaziz airport medina madinah al madinah المدينة المنورة"],
  ...
  ["MFM", "Macau International Airport", "Nossa Senhora do Carmo", "Macau", "Asia/Macau", 22.1496, 113.5920, "macau international airport nossa senhora do carmo macao aomen 澳门 澳門 마카오"],
  ...
  ["MGQ", "Aden Adde International Airport", "Mogadishu", "Somalia", "Africa/Mogadishu", 2.0144, 45.3047, "aden adde international airport mogadishu muqdisho"],
  ["MHD", "Mashhad International Airport", "Mashhad", "Iran", "Asia/Tehran", 36.2348, 59.6429, "mashhad international airport mashhad mashad مشهد"],
  ["MIA", "Miami International Airport", "Miami", "United States", "America/New_York", 25.7960, -80.2898, "miami international airport miami майами マイアミ 迈阿密 마이애미"],
  ...
  ["MLA", "Malta International Airport", "Valletta", "Malta", "Europe/Malta", 35.8459, 14.4915, "malta international airport valletta luqa"],
  ["MLE", "Velana International Airport", "Malé", "Maldives", "Indian/Maldives", 4.1918, 73.5291, "velana international airport malé velana international airport male maldives मालदीव"],
  ...
  ["MNL", "Ninoy Aquino International Airport", "Manila", "Philippines", "Asia/Manila", 14.5086, 121.0200, "ninoy aquino international airport manila pasay maynila 马尼拉 манила マニラ 마닐라"],
  ...
  ["MPM", "Maputo Airport", "Maputo", "Mozambique", "Africa/Maputo", -25.9208, 32.5726, "maputo airport maputo lourenco marques"],
  ...
  ["MRS", "Marseille Provence Airport", "Marseille", "France", "Europe/Paris", 43.4381, 5.2125, "marseille provence airport marseille bouches du rhône marignane marseille provence airport marseille bouches du rhone marignane marsella marsiglia марсель"],
  ["MRU", "Sir Seewoosagur Ramgoolam International Airport", "Plaine Magnien", "Mauritius", "Indian/Mauritius", -20.4302, 57.6836, "sir seewoosagur ramgoolam international airport plaine magnien mauritius port louis plaisance मॉरीशस"],
  ...
  ["MSQ", "Minsk National Airport", "Minsk", "Belarus", "Europe/Minsk", 53.8881, 28.0400, "minsk national airport minsk минск"],
  ...
  ["MUC", "Munich Airport", "Munich", "Germany", "Europe/Berlin", 48.3538, 11.7861, "munich airport munich munchen muenchen monaco di baviera мюнхен ミュンヘン 慕尼黑 뮌헨"],
  ["MUH", "Mersa Matruh International Airport", "Marsa Matruh", "Egypt", "Africa/Cairo", 31.3243, 27.2223],
  ["MUX", "Multan International Airport", "Multan", "Pakistan", "Asia/Karachi", 30.2032, 71.4191, "multan international airport multan ملتان"],
  ["MVD", "Carrasco General Cesáreo L. Berisso International Airport", "Ciudad de la Costa", "Uruguay", "America/Montevideo", -34.8356, -56.0265, "carrasco general cesáreo l berisso international airport ciudad de la costa carrasco general cesareo l berisso international airport ciudad de la costa монтевидео"],
  ...
  ["NAG", "Dr. Babasaheb Ambedkar International Airport", "Nagpur", "India", "Asia/Kolkata", 21.0922, 79.0472, "dr babasaheb ambedkar international airport nagpur naqpur नागपुर"],
  ["NAJ", "Nakhchivan International Airport", "Nakhchivan", "Azerbaijan", "Asia/Baku", 39.1888, 45.4584],
  ["NAN", "Nadi International Airport", "Nadi", "Fiji", "Pacific/Fiji", -17.7618, 177.4378, "nadi international airport nadi fiji"],
  ["NAP", "Naples International Airport", "Napoli", "Italy", "Europe/Rome", 40.8860, 14.2908, "naples international airport napoli neapel napoles неаполь ナポリ 那不勒斯 나폴리"],
  ...
  ["NBO", "Jomo Kenyatta International Airport", "Nairobi", "Kenya", "Africa/Nairobi", -1.3189, 36.9282, "jomo kenyatta international airport nairobi найроби ナイロビ 内罗毕"],
  ["NCE", "Nice-Côte d'Azur Airport", "Nice", "France", "Europe/Paris", 43.6584, 7.2159, "nice côte d azur airport nice alpes maritimes nice cote d azur airport nice alpes maritimes nizza niza ницца"],
  ...
  ["NDJ", "N'Djamena International Airport", "N'Djamena", "Chad", "Africa/Ndjamena", 12.1337, 15.0340, "n djamena international airport n djamena ndjamena"],
  ...
  ["NGO", "Chubu Centrair International Airport", "Tokoname", "Japan", "Asia/Tokyo", 34.8584, 136.8050, "chubu centrair international airport tokoname nagoya 名古屋 나고야"],
  ["NGS", "Nagasaki Airport", "Nagasaki", "Japan", "Asia/Tokyo", 32.9169, 129.9140, "nagasaki airport nagasaki 長崎"],
  ...
  ["NKG", "Nanjing Lukou International Airport", "Nanjing", "China", "Asia/Shanghai", 31.7350, 118.8659, "nanjing lukou international airport nanjing nanking 南京"],
  ...
  ["NQZ", "Nursultan Nazarbayev International Airport", "Astana", "Kazakhstan", "Asia/Almaty", 51.0270, 71.4671, "nursultan nazarbayev international airport astana nur sultan tselinograd астана нур-султан"],
  ["NRN", "Weeze (Niederrhein) Airport", "Weeze", "Germany", "Europe/Amsterdam", 51.6014, 6.1412],
  ["NRT", "Narita International Airport", "Tokyo", "Japan", "Asia/Tokyo", 35.7686, 140.3887, "narita international airport tokyo 成田"],
  ...
  ["NUE", "Nuremberg Airport", "Nuremberg", "Germany", "Europe/Berlin", 49.4987, 11.0781, "nuremberg airport nuremberg nurnberg nuernberg nuremberga нюрнберг"],
  ...
  ["OKA", "Naha International Airport", "Naha", "Japan", "Asia/Tokyo", 26.1924, 127.6398, "naha international airport naha okinawa 那覇 沖縄 오키나와"],
  ...
  ["OOL", "Gold Coast Airport", "Gold Coast", "Australia", "Australia/Brisbane", -28.1660, 153.5066, "gold coast airport gold coast coolangatta"],
  ["OPO", "Francisco de Sá Carneiro Airport", "Porto", "Portugal", "Europe/Lisbon", 41.2481, -8.6814, "francisco de sá carneiro airport porto francisco de sa carneiro airport porto oporto порту"],
  ...
  ["ORN", "Oran Es-Sénia (Ahmed Ben Bella) International Airport", "Es-Sénia", "Algeria", "Africa/Algiers", 35.6206, -0.6225, "oran es sénia ahmed ben bella international airport es sénia oran es senia ahmed ben bella international airport es senia وهران"],
  ...
  ["OTP", "Bucharest Henri Coandă International Airport", "Bucharest", "Romania", "Europe/Bucharest", 44.5718, 26.1033, "bucharest henri coandă international airport otopeni bucharest henri coanda international airport bucharest otopeni"],
  ["OUA", "Ouagadougou Thomas Sankara International Airport", "Ouagadougou", "Burkina Faso", "Africa/Ouagadougou", 12.3532, -1.5124, "ouagadougou thomas sankara international airport ouagadougou ouaga"],
  ...
  ["OVB", "Novosibirsk Tolmachevo Airport", "Novosibirsk", "Russia", "Asia/Novosibirsk", 55.0198, 82.6187, "novosibirsk tolmachevo airport novosibirsk новосибирск"],
  ...
  ["PAT", "Jay Prakash Narayan Airport", "Patna", "India", "Asia/Kolkata", 25.5913, 85.0880, "jay prakash narayan airport patna पटना"],
  ...
  ["PBH", "Paro International Airport", "Paro", "Bhutan", "Asia/Thimphu", 27.4032, 89.4246, "paro international airport paro thimphu"],
  ...
  ["PEN", "Penang International Airport", "Penang", "Malaysia", "Asia/Kuala_Lumpur", 5.2963, 100.2762, "penang international airport penang pulau pinang 槟城"],
  ["PER", "Perth International Airport", "Perth", "Australia", "Australia/Perth", -31.9403, 115.9670, "perth international airport perth перт"],
  ...
  ["PEW", "Bacha Khan International Airport", "Peshawar", "Pakistan", "Asia/Karachi", 33.9939, 71.5146, "bacha khan international airport peshawar پشاور"],
  ...
  ["PHL", "Philadelphia International Airport", "Philadelphia", "United States", "America/New_York", 39.8719, -75.2411, "philadelphia international airport philadelphia philly филадельфия フィラデルフィア 费城"],
  ...
  ["PMI", "Palma de Mallorca Airport", "Palma de Mallorca", "Spain", "Europe/Madrid", 39.5517, 2.7388, "palma de mallorca airport palma de mallorca majorca пальма"],
  ...
  ["PNQ", "Pune International Airport", "Pune", "India", "Asia/Kolkata", 18.5821, 73.9197, "pune international airport pune poona पुणे"],
  ...
  ["PPT", "Fa'a'ā International Airport", "Papeete", "French Polynesia", "Pacific/Tahiti", -17.5535, -149.6069, "fa a ā international airport papeete fa a a international airport papeete tahiti"],
  ...
  ["PRG", "Václav Havel Airport Prague", "Prague", "Czech Republic", "Europe/Prague", 50.1009, 14.2599, "václav havel airport prague prague vaclav havel airport prague prague praha prag praga прага プラハ 布拉格 프라하"],
  ...
  ["PTY", "Tocumen International Airport", "Tocumen", "Panama", "America/Panama", 9.0714, -79.3835, "tocumen international airport tocumen panama city ciudad de panama панама"],
  ...
  ["PUS", "Gimhae International Airport", "Busan", "South Korea", "Asia/Seoul", 35.1795, 128.9380, "gimhae international airport busan pusan 부산 釜山"],
  ...
  ["RAK", "Marrakesh Menara Airport", "Marrakesh", "Morocco", "Africa/Casablanca", 31.6048, -8.0358, "marrakesh menara airport marrakesh marrakech مراكش марракеш"],
  ["RAR", "Rarotonga International Airport", "Avarua", "Cook Islands", "Pacific/Rarotonga", -21.2027, -159.8060],
  ["RBA", "Rabat-Salé Airport", "Rabat", "Morocco", "Africa/Casablanca", 34.0515, -6.7515, "rabat salé airport rabat rabat sale airport rabat الرباط"],
  ...
  ["RGN", "Yangon International Airport", "Yangon", "Myanmar", "Asia/Yangon", 16.9073, 96.1332, "yangon international airport yangon rangoon ရန်ကုန် 仰光"],
  ...
  ["RIX", "Riga International Airport", "Riga", "Latvia", "Europe/Riga", 56.9208, 23.9707, "riga international airport riga рига"],
  ...
  ["RPR", "Swami Vivekananda Airport", "Raipur", "India", "Asia/Kolkata", 21.1804, 81.7388, "swami vivekananda airport raipur रायपुर"],
  ...
  ["RUH", "King Khalid International Airport", "Riyadh", "Saudi Arabia", "Asia/Riyadh", 24.9576, 46.6988, "king khalid international airport riyadh ar riyadh ar riyad الرياض эр-рияд रियाद リヤド 利雅得"],
  ["RUN", "Roland Garros Airport", "Sainte-Marie", "Réunion", "Indian/Reunion", -20.8901, 55.5189, "roland garros airport sainte marie reunion saint denis st denis"],
  ...
  ["SAH", "Sanaa International Airport", "Sanaa", "Yemen", "Asia/Aden", 15.4763, 44.2197, "sanaa international airport sanaa صنعاء"],
  ["SAI", "Siem Reap-Angkor International Airport", "Siem Reap", "Cambodia", "Asia/Phnom_Penh", 13.3697, 104.2238, "siem reap angkor international airport siem reap សៀមរាប"],
  ...
  ["SCL", "Comodoro Arturo Merino Benítez International Airport", "Santiago", "Chile", "America/Santiago", -33.3930, -70.7858, "comodoro arturo merino benítez international airport santiago comodoro arturo merino benitez international airport santiago santiago de chile santiago do chile сантьяго サンティアゴ 圣地亚哥"],
  ...
  ["SDJ", "Sendai Airport", "Natori", "Japan", "Asia/Tokyo", 38.1397, 140.9170, "sendai airport natori 仙台"],
  ["SDQ", "Las Américas International Airport", "Santo Domingo", "Dominican Republic", "America/Santo_Domingo", 18.4297, -69.6689, "las américas international airport santo domingo las americas international airport santo domingo санто-доминго"],
  ...
  ["SEA", "Seattle–Tacoma International Airport", "Seattle", "United States", "America/Los_Angeles", 47.4479, -122.3103, "seattle tacoma international airport seattle сиэтл シアトル 西雅图 시애틀"],
  ["SEZ", "Seychelles International Airport", "Victoria", "Seychelles", "Indian/Mahe", -4.6743, 55.5218, "seychelles international airport victoria mahe"],
  ...
  ["SGN", "Tan Son Nhat International Airport", "Ho Chi Minh City", "Vietnam", "Asia/Ho_Chi_Minh", 10.8188, 106.6520, "tan son nhat international airport ho chi minh city saigon hcmc sai gon tp hcm 胡志明市 хошимин ホーチミン 호치민"],
  ...
  ["SHE", "Shenyang Taoxian International Airport", "Shenyang", "China", "Asia/Shanghai", 41.6398, 123.4837, "shenyang taoxian international airport shenyang 沈阳"],
  ["SHJ", "Sharjah International Airport", "Sharjah", "United Arab Emirates", "Asia/Dubai", 25.3286, 55.5172, "sharjah international airport sharjah الشارقة"],
  ...
  ["SJJ", "Sarajevo International Airport", "Sarajevo", "Bosnia and Herzegovina", "Europe/Sarajevo", 43.8246, 18.3315, "sarajevo international airport sarajevo сарајево"],
  ["SJO", "Juan Santamaría International Airport", "San José", "Costa Rica", "America/Costa_Rica", 9.9939, -84.2088, "juan santamaría international airport san josé alajuela juan santamaria international airport san jose alajuela san jose de costa rica"],
  ...
  ["SKD", "Samarkand International Airport", "Samarkand", "Uzbekistan", "Asia/Samarkand", 39.7018, 66.9815, "samarkand international airport samarkand samarqand самарканд"],
  ["SKG", "Thessaloniki Macedonia International Airport", "Thessaloniki", "Greece", "Europe/Athens", 40.5193, 22.9700, "thessaloniki macedonia international airport thessaloniki saloniki salonica salonique θεσσαλονίκη салоники"],
  ["SKO", "Sadiq Abubakar III International Airport", "Sokoto", "Nigeria", "Africa/Lagos", 12.9157, 5.2075],
  ["SKP", "Skopje International Airport", "Ilinden", "North Macedonia", "Europe/Skopje", 41.9581, 21.6226, "skopje international airport ilinden скопје uskup"],
  ...
  ["SOF", "Sofia Airport", "Sofia", "Bulgaria", "Europe/Sofia", 42.6964, 23.4177, "sofia airport sofia sofiya софия"],
  ["SPU", "Split Saint Jerome Airport", "Split", "Croatia", "Europe/Zagreb", 43.5389, 16.2980, "split saint jerome airport split spalato"],
  ...
  ["SSA", "Deputado Luiz Eduardo Magalhães International Airport", "Salvador", "Brazil", "America/Bahia", -12.9086, -38.3225, "deputado luiz eduardo magalhães international airport salvador deputado luiz eduardo magalhaes international airport salvador salvador da bahia"],
  ["SSG", "Malabo International Airport", "Malabo", "Equatorial Guinea", "Africa/Malabo", 3.7553, 8.7087],
  ["SSH", "Sharm El Sheikh International Airport", "Sharm El Sheikh", "Egypt", "Africa/Cairo", 27.9773, 34.3947, "sharm el sheikh international airport sharm el sheikh شرم الشيخ шарм-эль-шейх"],
  ...
  ["STR", "Stuttgart Airport", "Stuttgart", "Germany", "Europe/Berlin", 48.6899, 9.2220, "stuttgart airport stuttgart stoccarda штутгарт シュトゥットガルト 斯图加特"],
  ["STT", "Cyril E. King Airport", "Charlotte Amalie", "U.S. Virgin Islands", "America/St_Thomas", 18.3371, -64.9773],
  ["STV", "Surat International Airport", "Surat", "India", "Asia/Kolkata", 21.1155, 72.7433, "surat international airport surat सूरत"],
  ["SUB", "Juanda International Airport", "Surabaya", "Indonesia", "Asia/Jakarta", -7.3798, 112.7870, "juanda international airport surabaya surabaja"],
  ...
  ["SVQ", "Seville Airport", "Seville", "Spain", "Europe/Madrid", 37.4180, -5.8931, "seville airport seville sevilla siviglia севилья"],
  ["SVX", "Koltsovo Airport", "Yekaterinburg", "Russia", "Asia/Yekaterinburg", 56.7431, 60.8027, "koltsovo airport yekaterinburg ekaterinburg sverdlovsk екатеринбург"],
  ...
  ["SXM", "Princess Juliana International Airport", "Sint Maarten", "Sint Maarten", "America/Lower_Princes", 18.0410, -63.1089, "princess juliana international airport sint maarten st maarten saint martin"],
  ["SXR", "Srinagar International Airport", "Srinagar", "India", "Asia/Kolkata", 33.9871, 74.7742, "srinagar international airport srinagar श्रीनगर"],
  ["SYD", "Sydney Kingsford Smith International Airport", "Sydney", "Australia", "Australia/Sydney", -33.9461, 151.1770, "sydney kingsford smith international airport sydney mascot сидней シドニー 悉尼 시드니"],
  ["SYR", "Syracuse Hancock International Airport", "Syracuse", "United States", "America/New_York", 43.1112, -76.1063],
  ["SYX", "Sanya Phoenix International Airport", "Sanya", "China", "Asia/Shanghai", 18.3029, 109.4120, "sanya phoenix international airport sanya tianya 三亚"],
  ["SYZ", "Shiraz Shahid Dastghaib International Airport", "Shiraz", "Iran", "Asia/Tehran", 29.5392, 52.5898, "shiraz shahid dastghaib international airport shiraz شیراز"],
  ...
  ["SZX", "Shenzhen Bao'an International Airport", "Shenzhen", "China", "Asia/Shanghai", 22.6395, 113.8033, "shenzhen bao an international airport shenzhen 深圳 шэньчжэнь 선전"],
  ...
  ["TAE", "Daegu International Airport", "Daegu", "South Korea", "Asia/Seoul", 35.8944, 128.6570, "daegu international airport daegu 대구"],
  ...
  ["TAO", "Qingdao Jiaodong International Airport", "Qingdao", "China", "Asia/Shanghai", 36.3620, 120.0882, "qingdao jiaodong international airport qingdao jiaozhou tsingtao 青岛"],
  ["TAS", "Tashkent International Airport", "Tashkent", "Uzbekistan", "Asia/Tashkent", 41.2579, 69.2812, "tashkent international airport tashkent toshkent ташкент тошкент"],
  ...
  ["TBS", "Tbilisi International Airport", "Tbilisi", "Georgia", "Asia/Tbilisi", 41.6692, 44.9547, "tbilisi international airport tbilisi tiflis тбилиси თბილისი"],
  ["TBU", "Fua'amotu International Airport", "Nuku'alofa", "Tonga", "Pacific/Tongatapu", -21.2414, -175.1492],
  ["TBZ", "Tabriz International Airport", "Tabriz", "Iran", "Asia/Tehran", 38.1339, 46.2350, "tabriz international airport tabriz تبریز"],
  ...
  ["TIA", "Tirana International Airport Mother Teresa", "Rinas", "Albania", "Europe/Tirane", 41.4147, 19.7206, "tirana international airport mother teresa rinas tirane"],
  ...
  ["TLL", "Lennart Meri Tallinn Airport", "Tallinn", "Estonia", "Europe/Tallinn", 59.4132, 24.8326, "lennart meri tallinn airport tallinn tallin таллин reval"],
  ...
  ["TLV", "Ben Gurion International Airport", "Tel Aviv", "Israel", "Asia/Jerusalem", 32.0114, 34.8867, "ben gurion international airport tel aviv tel aviv yafo תל אביב тель-авив تل أبيب テルアビブ 特拉维夫"],
  ...
  ["TNG", "Tangier Ibn Battuta Airport", "Tangier", "Morocco", "Africa/Casablanca", 35.7317, -5.9215, "tangier ibn battuta airport tangier tanger طنجة"],
  ...
  ["TNR", "Ivato International Airport", "Antananarivo", "Madagascar", "Indian/Antananarivo", -18.7969, 47.4788, "ivato international airport antananarivo tana tananarive"],
  ...
  ["TRN", "Turin Airport", "Caselle Torinese", "Italy", "Europe/Rome", 45.2008, 7.6496, "turin airport caselle torinese to турин トリノ 都灵 토리노"],
  ...
  ["TRV", "Thiruvananthapuram International Airport", "Thiruvananthapuram", "India", "Asia/Kolkata", 8.4819, 76.9200, "thiruvananthapuram international airport thiruvananthapuram trivandrum तिरुवनंतपुरम തിരുവനന്തപുരം"],
  ["TRW", "Bonriki International Airport", "South Tarawa", "Kiribati", "Pacific/Tarawa", 1.3816, 173.1470],
  ["TRZ", "Tiruchirappalli International Airport", "Tiruchirappalli", "India", "Asia/Kolkata", 10.7629, 78.7177, "tiruchirappalli international airport tiruchirappalli tiruchirappally trichy तिरुचिरापल्ली त्रिची"],
  ...
  ["TSN", "Tianjin Binhai International Airport", "Tianjin", "China", "Asia/Shanghai", 39.1244, 117.3460, "tianjin binhai international airport tianjin tientsin 天津"],
  ...
  ["TUN", "Tunis Carthage International Airport", "Tunis", "Tunisia", "Africa/Tunis", 36.8510, 10.2272, "tunis carthage international airport tunis تونس тунис"],
  ...
  ["UBN", "Ulaanbaatar Chinggis Khaan International Airport", "Ulaanbaatar", "Mongolia", "Asia/Ulaanbaatar", 47.6469, 106.8198, "ulaanbaatar chinggis khaan international airport ulaanbaatar sergelen ulan bator улаанбаатар улан-батор 乌兰巴托"],
  ["UDR", "Maharana Pratap Airport", "Udaipur", "India", "Asia/Kolkata", 24.6177, 73.8961, "maharana pratap airport udaipur उदयपुर"],
  ...
  ["UPG", "Sultan Hasanuddin International Airport", "Makassar", "Indonesia", "Asia/Makassar", -5.0755, 119.5537, "sultan hasanuddin international airport makassar ujung pandang"],
  ["URA", "Manshuk Mametova International Airport", "Uralsk", "Kazakhstan", "Asia/Oral", 51.1520, 51.5437],
  ["URC", "Ürümqi Tianshan International Airport", "Ürümqi", "China", "Asia/Shanghai", 43.9136, 87.4794, "ürümqi tianshan international airport ürümqi urumqi tianshan international airport urumqi 乌鲁木齐"],
  ["USM", "Samui International Airport", "Na Thon", "Thailand", "Asia/Bangkok", 9.5478, 100.0620, "samui international airport na thon ko island koh samui เกาะสมุย"],
  ["UTH", "Udon Thani International Airport", "Udon Thani", "Thailand", "Asia/Bangkok", 17.3862, 102.7886],
  ["UTP", "U-Tapao–Rayong–Pattaya International Airport", "Rayong", "Thailand", "Asia/Bangkok", 12.6799, 101.0050, "u tapao rayong pattaya international airport rayong พัทยา"],
  ...
  ["VCE", "Venice Marco Polo Airport", "Venezia", "Italy", "Europe/Rome", 45.5053, 12.3519, "venice marco polo airport venezia ve venedig venecia венеция ベネチア ヴェネツィア 威尼斯 베네치아"],
  ...
  ["VFA", "Victoria Falls International Airport", "Victoria Falls", "Zimbabwe", "Africa/Harare", -18.0974, 25.8369, "victoria falls international airport victoria falls vic falls"],
  ["VGA", "Vijayawada International Airport", "Vijayawada", "India", "Asia/Kolkata", 16.5300, 80.8049, "vijayawada international airport vijayawada vidzhayavada bezawada"],
  ["VIE", "Vienna International Airport", "Vienna", "Austria", "Europe/Vienna", 48.1103, 16.5697, "vienna international airport vienna wien vienne viena вена ウィーン 维也纳 빈"],
  ...
  ["VNO", "Vilnius International Airport", "Vilnius", "Lithuania", "Europe/Vilnius", 54.6341, 25.2858, "vilnius international airport vilnius wilno vilna вильнюс"],
  ["VNS", "Lal Bahadur Shastri International Airport", "Varanasi", "India", "Asia/Kolkata", 25.4522, 82.8625, "lal bahadur shastri international airport varanasi benares banaras kashi वाराणसी बनारस"],
  ...
  ["VTE", "Wattay International Airport", "Vientiane", "Laos", "Asia/Vientiane", 17.9851, 102.5667, "wattay international airport vientiane viangchan ວຽງຈັນ"],
  ["VTZ", "Alluri Sitarama Raju International Airport (Vizag)", "Visakhapatnam", "India", "Asia/Kolkata", 17.9715, 83.5036, "alluri sitarama raju international airport vizag visakhapatnam विशाखापत्तनम"],
  ["VVI", "Viru Viru International Airport", "Santa Cruz", "Bolivia", "America/La_Paz", -17.6448, -63.1354, "viru viru international airport santa cruz santa cruz de la sierra"],
  ["VVO", "Vladivostok International Airport", "Artyom", "Russia", "Asia/Vladivostok", 43.3963, 132.1482, "vladivostok international airport artyom владивосток"],
  ...
  ["WAW", "Warsaw Chopin Airport", "Warsaw", "Poland", "Europe/Warsaw", 52.1657, 20.9671, "warsaw chopin airport warsaw warszawa warschau varsovia варшава ワルシャワ 华沙 바르샤바"],
  ["WDH", "Hosea Kutako International Airport", "Windhoek", "Namibia", "Africa/Windhoek", -22.4799, 17.4709],
  ["WLG", "Wellington International Airport", "Wellington", "New Zealand", "Pacific/Auckland", -41.3268, 174.8069, "wellington international airport wellington te whanganui a tara"],
  ...
  ["WRO", "Copernicus Wrocław Airport", "Wrocław", "Poland", "Europe/Warsaw", 51.1037, 16.8821, "copernicus wroclaw airport wroclaw breslau"],
  ["WTB", "Toowoomba Wellcamp Airport", "Toowoomba", "Australia", "Australia/Brisbane", -27.5583, 151.7933],
  ["WUH", "Wuhan Tianhe International Airport", "Wuhan", "China", "Asia/Shanghai", 30.7748, 114.2137, "wuhan tianhe international airport wuhan huangpi 武汉"],
  ...
  ["XIY", "Xi'an Xianyang International Airport", "Xi'an", "China", "Asia/Shanghai", 34.4422, 108.7624, "xi an xianyang international airport xi an xian sian 西安"],
  ["XMN", "Xiamen Gaoqi International Airport", "Xiamen", "China", "Asia/Shanghai", 24.5439, 118.1275, "xiamen gaoqi international airport xiamen amoy 厦门"],
  ...
  ["YIA", "Yogyakarta International Airport", "Yogyakarta", "Indonesia", "Asia/Jakarta", -7.9053, 110.0573, "yogyakarta international airport yogyakarta jogja jogjakarta yogya djokjakarta"],
  ...
  ["YOW", "Ottawa Macdonald-Cartier International Airport", "Ottawa", "Canada", "America/Toronto", 45.3225, -75.6692, "ottawa macdonald cartier international airport ottawa оттава"],
  ["YQB", "Quebec Jean Lesage International Airport", "Quebec", "Canada", "America/Toronto", 46.7911, -71.3933],
  ["YUL", "Montreal / Pierre Elliott Trudeau International Airport", "Montréal", "Canada", "America/Toronto", 45.4678, -73.7423, "montreal pierre elliott trudeau international airport montréal montreal pierre elliott trudeau international airport montreal монреаль モントリオール 蒙特利尔"],
  ["YVR", "Vancouver International Airport", "Vancouver", "Canada", "America/Vancouver", 49.1939, -123.1840, "vancouver international airport vancouver ванкувер バンクーバー 温哥华 밴쿠버"],
  ...
  ["YYC", "Calgary International Airport", "Calgary", "Canada", "America/Edmonton", 51.1188, -114.0099, "calgary international airport calgary калгари"],
  ...
  ["YYZ", "Toronto Pearson International Airport", "Toronto", "Canada", "America/Toronto", 43.6759, -79.6294, "toronto pearson international airport toronto торонто トロント 多伦多 토론토 टोरंटो تورونتو"],
  ["ZAD", "Zadar Airport", "Zadar", "Croatia", "Europe/Zagreb", 44.0970, 15.3536],
  ["ZAG", "Zagreb Franjo Tuđman International Airport", "Velika Gorica", "Croatia", "Europe/Zagreb", 45.7429, 16.0688, "zagreb franjo tudman international airport velika gorica agram загреб"],
  ...
  ["ZNZ", "Abeid Amani Karume International Airport", "Zanzibar", "Tanzania", "Africa/Dar_es_Salaam", -6.2220, 39.2249, "abeid amani karume international airport zanzibar unguja"],
  ["ZQN", "Queenstown Airport", "Queenstown", "New Zealand", "Pacific/Auckland", -45.0192, 168.7464],
  ["ZRH", "Zürich Airport", "Zurich", "Switzerland", "Europe/Zurich", 47.4581, 8.5481, "zürich airport zurich zurich airport zurich zurigo цюрих チューリッヒ 苏黎世 취리히"],
...
const CITY_AIRPORTS: Record<string, string[]> = {
  ...
  "londra": ["LHR", "LGW", "STN", "LTN"],
  "londyn": ["LHR", "LGW", "STN", "LTN"],
  "лондон": ["LHR", "LGW", "STN", "LTN"],
  "لندن": ["LHR", "LGW", "STN", "LTN"],
  "लंदन": ["LHR", "LGW", "STN", "LTN"],
  "ロンドン": ["LHR", "LGW", "STN", "LTN"],
  "伦敦": ["LHR", "LGW", "STN", "LTN"],
  "런던": ["LHR", "LGW", "STN", "LTN"],
  "new york": ["JFK", "EWR", "LGA"],
  "nueva york": ["JFK", "EWR", "LGA"],
  "nova york": ["JFK", "EWR", "LGA"],
  "nova iorque": ["JFK", "EWR", "LGA"],
  "нью-йорк": ["JFK", "EWR", "LGA"],
  "ニューヨーク": ["JFK", "EWR", "LGA"],
  "纽约": ["JFK", "EWR", "LGA"],
  "뉴욕": ["JFK", "EWR", "LGA"],
  "न्यूयॉर्क": ["JFK", "EWR", "LGA"],
  "نيويورك": ["JFK", "EWR", "LGA"],
  "nyc": ["JFK", "EWR", "LGA"],
  ...
  "moskau": ["SVO", "DME", "VKO", "ZIA"],
  "moscu": ["SVO", "DME", "VKO", "ZIA"],
  "moscou": ["SVO", "DME", "VKO", "ZIA"],
  "москва": ["SVO", "DME", "VKO", "ZIA"],
  "موسكو": ["SVO", "DME", "VKO", "ZIA"],
  "मास्को": ["SVO", "DME", "VKO", "ZIA"],
  "モスクワ": ["SVO", "DME", "VKO", "ZIA"],
  "莫斯科": ["SVO", "DME", "VKO", "ZIA"],
  "모스크바": ["SVO", "DME", "VKO", "ZIA"],
  "sao paulo": ["GRU", "CGH", "VCP"],
  "sampa": ["GRU", "CGH", "VCP"],
  "san pablo": ["GRU", "CGH", "VCP"],
  "сан-паулу": ["GRU", "CGH", "VCP"],
  "サンパウロ": ["GRU", "CGH", "VCP"],
  "圣保罗": ["GRU", "CGH", "VCP"],
  "상파울루": ["GRU", "CGH", "VCP"],
  ...
  "자카르타": ["CGK", "HLP"],
  "tehran": ["IKA", "THR"],
  // Otopeni and Băneasa both carry the city, so a bare "bucharest" tied. The
  // group orders them and the world table's names for the city key off it.
  "bucharest": ["OTP", "BBU"],
  "bucuresti": ["OTP", "BBU"],
  "bukarest": ["OTP", "BBU"],
  "bucarest": ["OTP", "BBU"],
  ...
  "bsas": ["EZE", "AEP"],
  "baires": ["EZE", "AEP"],
  "capital federal": ["EZE", "AEP"],
  "буэнос-айрес": ["EZE", "AEP"],
  "ブエノスアイレス": ["EZE", "AEP"],
  "布宜诺斯艾利斯": ["EZE", "AEP"],
  "부에노스아이레스": ["EZE", "AEP"],
  ...
  "estocolmo": ["ARN", "NYO", "VST"],
  "stoccolma": ["ARN", "NYO", "VST"],
  "стокгольм": ["ARN", "NYO", "VST"],
  "oslo": ["OSL", "TRF"],
  "glasgow": ["GLA", "PIK"],
  "taipei": ["TPE", "TSA"],
  "taibei": ["TPE", "TSA"],
  ...
  "сан-франциско": ["SFO", "OAK", "SJC"],
  "サンフランシスコ": ["SFO", "OAK", "SJC"],
  "旧金山": ["SFO", "OAK", "SJC"],
  "三藩市": ["SFO", "OAK", "SJC"],
  "샌프란시스코": ["SFO", "OAK", "SJC"],
  "los angeles": ["LAX", "BUR", "SNA", "LGB", "ONT"],
  "la": ["LAX", "BUR", "SNA", "LGB", "ONT"],
  "лос-анджелес": ["LAX", "BUR", "SNA", "LGB", "ONT"],
  "ロサンゼルス": ["LAX", "BUR", "SNA", "LGB", "ONT"],
  "洛杉矶": ["LAX", "BUR", "SNA", "LGB", "ONT"],
  "로스앤젤레스": ["LAX", "BUR", "SNA", "LGB", "ONT"],
  "لوس أنجلوس": ["LAX", "BUR", "SNA", "LGB", "ONT"],
  // ONE-AIRPORT GROUPS, so that a two-letter nickname can be a key: the length
  // floor does not apply to a curated key, and a row alias under three letters
  // could never be reached. cityAirports on a one-code group is the airport
  // itself, which is what the panel shows for any single-airport city anyway.
  // The nicknames themselves -- "hk", "sg", "la", "sf", "dc", "kl" and the rest
  // -- are written under these keys by tools/add_aliases.mjs.
  "hong kong": ["HKG"],
  "hk": ["HKG"],
  "hongkong": ["HKG"],
  "xianggang": ["HKG"],
...
// ONE ROW OF THE HAYSTACK: the airport, its search string, and its city and
// name already folded, so a query is compared against text normalised the same
// way without normalising 1,223 rows again on every lookup.
type HaystackRow = { a: Airport; s: string; city: string; name: string };
// CITY_AIRPORTS WITH ITS KEYS FOLDED, so "são paulo", "İstanbul" and a key in
// Hangul -- which NFD takes apart into jamo -- are looked up in the same form a
// query arrives in. The source map keeps its readable keys.
...
function build() {
  ...
  INDEX = new Map();
  CURATED = new Map();
  for (const key of Object.keys(CITY_AIRPORTS)) CURATED.set(normalizeTerm(key), CITY_AIRPORTS[key]);
  PLACES = new Set(CURATED.keys());
  ...
  HAYSTACK = AIRPORT_ROWS.map(r => {
    ...
    INDEX!.set(a.iata, a);
    // normalizeTerm OVER THE STORED STRING AS WELL AS THE FALLBACK. The rows
    // were written before the fold and the scripts existed, so the stored
    // haystack is folded here, once, at build, and a query folded the same way
    // lands on it; the call is idempotent on text that was already normalised.
    // The fallback needs it for its own reason: "O'Hare" would otherwise be one
    // word to the data and two to the device.
    const s = normalizeTerm(r[7] ?? `${a.name} ${a.city}`);
    const city = normalizeTerm(a.city);
    const name = normalizeTerm(a.name);
    PLACES!.add(city);
    ...
    // The length floor is for Latin words; 東京 is two characters and a city.
    for (const w of s.split(' ')) {
      if ((w.length >= MIN_TERM || !isLatinTerm(w)) && !HAYSTACK_STOPWORDS.has(w) && !/^\d+$/.test(w)) PLACES!.add(w);
    }
    return { a, s, city, name };
  });
}
...
export function isKnownPlace(term: string): boolean {
  ...
  // A curated key is a place at any length: "la", "sf" and "hk" were written
  // down on purpose. The floor below is for words nobody vouched for.
  if (CURATED!.has(q)) return true;
  if (q.length < MIN_TERM && isLatinTerm(q)) return false;
  if (PLACES!.has(q)) return true;
  return q.length === 3 && INDEX!.has(q.toUpperCase());
}

// ── WHAT A TERM LOOKS LIKE ONCE THE RESOLVER SEES IT ────────────────────────
//
// LOWERCASE, DIACRITICS FOLDED, THE LETTERS OF EVERY SCRIPT THE DATA CARRIES
// KEPT, everything else a space. Applied to the data at build and to every
// query, so the two cannot drift.
//
// THE FOLD IS NEW, AND "SAN JOSÉ" IS WHY. The city tier compared accented text
// exactly: "san jose" found California and only California, "san josé" Costa
// Rica and only Costa Rica; "bogotá" reached Bogotá by the typo tier alone,
// "zürich" ranked below "zurich", and "İstanbul" came apart into two words.
// NFD separates a letter from its accent and the Latin combining range is
// dropped; the few letters NFD leaves whole -- ø æ ß ł đ ð þ œ -- are mapped
// by hand. The call is guarded, so an engine without normalize degrades to the
// old behaviour rather than failing.
//
// THE SCRIPTS ARE NEW TOO. The old class kept Latin letters only, so 東京 and
// Москва normalised to nothing and never reached the device's own data. The
// ranges below are the scripts tools/aliases.mjs writes in: Greek, Cyrillic,
// Armenian, Hebrew, Arabic with its Persian and Urdu supplement, Georgian, the
// Indic family from Devanagari to Sinhala, Thai, Lao, Myanmar, Khmer, Ethiopic,
// Hangul as syllables and as the jamo NFD turns them into, kana and the CJK
// ideographs. Explicit ranges rather than \p{L}, so the expression needs no `u`
// flag and asks nothing of the engine this file cannot test.
//
// MARKS STAY WITH THEIR LETTERS. An Indic vowel sign, a Thai tone mark or an
// Arabic harakat is part of the word; only the Latin combining range is
// stripped, and only after NFD has separated it from its base.
const NON_TERM_RE = new RegExp(
  '[^0-9a-z'
  + '\u00c0-\u024f'                 // Latin-1 Supplement, Latin Extended-A and -B
  + '\u0370-\u03ff'                 // Greek
  + '\u0400-\u04ff'                 // Cyrillic
  + '\u0530-\u058f'                 // Armenian
  + '\u0590-\u05ff'                 // Hebrew
  + '\u0600-\u06ff\u0750-\u077f'    // Arabic, Arabic Supplement
  + '\u0900-\u0dff'                 // Devanagari through Sinhala
  + '\u0e00-\u0eff'                 // Thai, Lao
  + '\u1000-\u109f'                 // Myanmar
  + '\u10a0-\u10ff'                 // Georgian
  + '\u1100-\u11ff'                 // Hangul jamo
...
const FOLD: [RegExp, string][] = [
  [/ø/g, 'o'], [/æ/g, 'ae'], [/ß/g, 'ss'], [/ł/g, 'l'],
  [/đ/g, 'd'], [/ð/g, 'd'], [/þ/g, 'th'], [/œ/g, 'oe'],
];
export function normalizeTerm(term: string): string {
  ...
  return t.replace(NON_TERM_RE, ' ').replace(/\s+/g, ' ').trim();
}

// WHETHER A NORMALISED TERM IS LATIN, which decides two things. MIN_TERM, the
// three-letter floor that keeps "de" from matching a large part of the file,
// applies to Latin text and not to 東京, which is two characters and a whole
// city. And the typo tiers, which count edits between letters, run on Latin
// text only: one edit inside an ideograph is a different word, not a slip.
const LATIN_RE = /^[0-9a-z ]*$/;
export function isLatinTerm(q: string): boolean {
  return LATIN_RE.test(q);
}
...
function rankOf(h: HaystackRow, q: string): number {
  const { a, s, city, name } = h;
...
// Latin terms under three characters match nothing: two letters would pull in a
// large part of the file and mean nothing to a reader. A curated key is exempt,
// because someone wrote it down, and so is a term in another script, where two
// characters can be a whole city. See isLatinTerm.
const MIN_TERM = 3;
...
function fuzzyRank(h: HaystackRow, q: string): number {
  // Edits are counted between Latin letters. See isLatinTerm.
  if (!isLatinTerm(q)) return -1;
  const { s, city } = h;
  ...
  let dw = FUZZY_NONE;
  for (const w of s.split(' ')) {
    // A Latin typo is never one edit from a word in another script, and the
    // table added several hundred of those; skipping them keeps the pass fast.
    if (w.length < FUZZY_TARGET_MIN || HAYSTACK_STOPWORDS.has(w) || !isLatinTerm(w)) continue;
...
function scoreAll(q: string): { a: Airport; rank: number }[] {
  ...
  for (const h of HAYSTACK) {
    const rank = rankOf(h, q);
    if (rank >= 0) out.push({ a: h.a, rank });
  }
...
export function findAirports(term: string, limit = 8): Airport[] {
  const q = normalizeTerm(term);
  build();
  // THE CURATED MAP BEFORE THE LENGTH FLOOR. "la", "sf" and "hk" are two
  // letters and were written down on purpose; the floor is for guesses.
  const curated = CURATED!.get(q);
  if (curated) {
    const hit = curated.map(c => INDEX!.get(c)).filter((x): x is Airport => !!x);
    if (hit.length > 0) return hit.slice(0, limit);
  }
  if (q.length < MIN_TERM && isLatinTerm(q)) return [];
...
export function resolveAirportName(term: string): { airport: Airport; options: Airport[]; rank: number } | null {
  ...
  if (q.length < MIN_TERM && isLatinTerm(q)) return null;
